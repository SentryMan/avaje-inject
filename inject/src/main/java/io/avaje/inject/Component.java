 ...
 *
 * <p>This is an alternative to using the standard <code>@Singleton</code> annotation. We generally
 * use <code>@Component</code> when we:
 *
 * <ul>
 *   <li>Want to use avaje-inject in a project that has some other library using <code>@Singleton
 *       </code>
 *   <li>Want to support BOTH <code>javax.inject</code> and <code>jakarta.inject</code>
 * </ul>
 *
 * <h3>Example</h3>
 *
 ...
 *
 * <p>Set {@link InjectModule#ignoreSingleton()} <code>true</code> to get avaje-inject to ignore
