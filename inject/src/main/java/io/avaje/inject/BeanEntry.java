...
public interface BeanEntry {
   ...
   *
   * <p>This is the set of type, interface types and annotation types that the entry is registered
   * for.
   */
  Set<String> keys();
   ...
   *
   * <p>This is true if the keys contains the canonical name of the given type.
   *
   * @param type The type to match. Can be any type including concrete, interface or annotation
   *     type.
   */
