...
public interface Builder {
   ...
   * @param suppliedBeans The list of beans (typically test doubles) supplied when building the
   *     context.
  ...
  /**
   * Register the next bean as having Primary priority. Highest priority, will be used over any
   * other matching beans.
   */
  Builder asPrimary();
