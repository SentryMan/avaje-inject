 ...
 *
 * <p>The avaje-jex-test provides a plugin that would start a http server and inject a http client
 * into the field for the tests to use.
 */
public interface Plugin {
   ...
   *
   * <p>The scope will be closed appropriately (afterEach or afterAll).
   */
  ...
  interface Scope {
     ...
     *
     * <p>For example, avaje-jex-test will create a http client.
     */
