...
class SpyMeterTest {
  ...
  private static final String METRIC =
      "TempQualifier(defaultVal=0, inject={@NestedAnnotation(inject={})},"
          + " someOtherString=\"celsi\", value={CELSIUS})";
  private static final String IMPERIAL =
      "TempQualifier(defaultVal=0, inject={@NestedAnnotation(inject={})}, someOtherString=\"far\","
          + " value={FAHRENHEIT})";
